...
export default function TransactionViewer() {
    ...
    React.useMemo(async () => {
        ...
        const chainConfig = await getChain('fether');
        ...
        const tryFetchTrace = () => {
            doApiRequest<TraceResponse>(`/api/v1/trace/fether/${txhash}`)
                .then((traceResponse) => {
                    ...
                    Object.keys(labels).forEach((addr) => delete customLabels['fether'][addr]);
