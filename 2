...
contract SecretKeeper is Ownable {
    ...
    SecretStorage public secretInStorage =
        SecretStorage(
            6969,
            "leedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedleleedle"
        );
